...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Initialisation des composants d'interface utilisateur principaux.
     */
    ...
    /**
     * Configuration du RecyclerView avec adaptation et gestion des événements de suppression.
     */
    ...
    /**
     * Met en place les écouteurs d'événements pour les interactions utilisateur.
     */
    ...
    /**
     * Affiche un dialogue modal permettant l'ajout d'un nouveau compte avec saisie du solde et type.
     */
    ...
    /**
     * Récupère et affiche la liste complète des comptes depuis le service web SOAP de façon asynchrone.
     */
